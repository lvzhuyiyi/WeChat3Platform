...
public class ResourceUtil {
	...
	public static final SysUsers getSessionUser() {
	...
	public static final void setSessionUser(SysUsers user) {
		HttpSession session = ContextHolderUtils.getSession();
	 ...
	 * @return
	 */
	public static final WeiXinPublicUser getWeiXinAccount() {
		HttpSession session = ContextHolderUtils.getSession();
		if (session.getAttribute(WeiXinConstants.WEIXIN_ACCOUNT) != null) {
			WeiXinPublicUser WeixinPublicUser = (WeiXinPublicUser) session
	 ...
	 * @return
	 */
	public static final void setWeiXinAccount(WeiXinPublicUser weixinPublicUser) {
		HttpSession session = ContextHolderUtils.getSession();
		session.setAttribute(WeiXinConstants.WEIXIN_ACCOUNT, weixinPublicUser);
	}
